...
#define RUBY_PLATFORM "arm-darwin9"
#define RUBY_ARCHLIB "/usr/local/lib/ruby/1.8/arm-darwin9"
#define RUBY_SITE_ARCHLIB "/usr/local/lib/ruby/site_ruby/1.8/arm-darwin9"
#define RUBY_VENDOR_ARCHLIB "/usr/local/lib/ruby/vendor_ruby/1.8/arm-darwin9"
